...
const LatestEpisode = ({ data: { description, title }, date, url }) => html`
  <article class="mb-10 px-6 py-8 rounded -mx-6 bg-[#f1f3f5]">
    <div class="max-w-2xl mx-auto">
      ...
      <${EpisodeMeta} class="mb-4" date=${date} />
...
const Episode = ({ data: { description, title }, date, url }) => html`
  <article class="w-full py-6 md:(w-1/2 pr-6)">
    <div class="mr-3">
      ...
      <${EpisodeMeta} class="mb-2" date=${date} />
      <p>${description}</p>
    </div>
  </article>
`
